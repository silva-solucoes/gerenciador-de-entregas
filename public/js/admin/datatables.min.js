        ...
        var a = e.oClasses,
            ...
            c =
                ((a = t("<div/>", {
                    ...
                    class: a.sFilter,
                }).append(t("<label class='col-md-12'/>").append(u))),
                (l = function () {
    ...
    Xt("columns()", function (e, n) {
        ...
        (qt.defaults = {
            ...
            oLanguage: {
                ...
                sSearch: "Procurar:",
                sSearchPlaceholder: "Digite para buscar...",
                sUrl: "",
...
!(function (e) {
    ...
    return (
        e.extend(!0, o.defaults, {
            dom: "<'row d-flex justify-content-between align-items-center'<'col-md-4'l><'col-md-4 text-center'><'col-md-4'f>>" +
         "<'row'<'col-sm-12'tr>>" +
